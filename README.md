...
```sh
npm install sanity-plugin-skynetaccessibility-scanner
```
...
import {SkynetAccessibilityScannerPlugin} from 'sanity-plugin-skynetaccessibility-scanner'

export default defineConfig({
  //...
  plugins: [SkynetAccessibilityScannerPlugin()],
})
```
